...
public class IngredientsController : ControllerBase
{
    ...
    public IngredientsController(CocktailService cocktailService)
    {
    ...
    //[HttpGet()]
    //public async Task<IActionResult> FilterByIngredientCategories([FromQuery] List<string> categories, [FromQuery] List<string> q)
    //{
